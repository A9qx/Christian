...
module.exports = {
    ...
    async execute(interaction) {
        const aboutEmbed = new EmbedBuilder()
            ...
            .setThumbnail('https://static.wikia.nocookie.net/villainsfanon/images/4/4e/Troll-Face-Meme-PNG.png/revision/latest/scale-to-width-down/1200?cb=20190104124219')
            .setTimestamp()
